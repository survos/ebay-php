 ...
 */
final readonly class RegionalProductCompliancePolicies
{
    /**
     * @param list<CountryPolicy>|null $countryPolicies The array of country-specific product compliance policies to be used by an offer when it is published and converted to a listing.
     */
