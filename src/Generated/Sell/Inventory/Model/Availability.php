...
{
    /**
     * @param list<PickupAtLocationAvailability>|null $pickupAtLocationAvailability This container consists of an array of one or more of the merchant's physical store locations where the inventory item is available for In-Store Pickup orders. The merchant's location, the quantity available, and the ful...
     * @param ShipToLocationAvailability|null $shipToLocationAvailability This container specifies the quantity of the inventory item that are available for purchase across one or more eBay marketplaces.
     */
