 ...
 */
final readonly class InventoryItemWithSkuLocaleGroupid
{
    /**
     * @param AvailabilityWithAll|null $availability This container is used to specify the quantity of the inventory item that are available for purchase if the item will be shipped to the buyer, and the quantity of the inventory item that are available for In-Store Pickup...
     ...
     * @param list<string>|null $groupIds This array is returned if the inventory item is associated with any inventory item group(s). The value(s) returned in this array are the unique identifier(s) of the inventory item group(s). This array is not returned if...
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            conditionDescriptors: isset($data['conditionDescriptors']) && is_array($data['conditionDescriptors'])
                ...
                : null,
            groupIds: isset($data['groupIds']) ? (array) $data['groupIds'] : null,
