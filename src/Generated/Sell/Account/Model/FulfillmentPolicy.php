...
/**
 * This type is used by the fulfillmentPolicy response container, a container which defines a seller's fulfillment policy for a specific marketplace.
 *
 * Generated from eBay's Account v1 API OpenAPI contract. Do not edit.
 * Every property is nullable because the contract declares no required fields.
 */
final readonly class FulfillmentPolicy
{
    /**
     * @param list<CategoryType>|null $categoryTypes This container indicates whether the fulfillment policy applies to motor vehicle listings, or if it applies to non-motor vehicle listings.
     ...
     * @param bool|null $globalShipping Note: This field is only applicable for the eBay United Kingdom marketplace (EBAY_GB). If returned as true, eBay's Global Shipping Program will be used by the seller to ship items to international locations. eBay Interna...
     ...
     * @param bool|null $localPickup If returned as true, local pickup is available for this policy.
